import onlinestoreDATA
mycursor = onlinestoreDATA.mydb.cursor() #เก็บการทำงานของsql
...
def start():
    while True:
        print("\nเมนูหลัก:")
        user_input = input("กรุณาพิมพ์คำว่า 'user', 'product', 'categories', 'order' หรือ 'close' เพื่อจบการทำงานทั้งหมด: ")
